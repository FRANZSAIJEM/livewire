<template>
  <div class="body">
    ...
    <div v-for="attendance in attendances" class="text-center">
      <div class="card-body">
        <div class="row">
          <table class="table table-bordered shadow-sm">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <button data-id="{{ id }}" class="btn btn-success m-2 " data-bs-toggle="modal" data-bs-target="#exampleModal">&check; Edit</button>
                  <button @click="removeAttendance(attendance.id)" class="btn btn-danger m-2 edit-button">&cross; Remove</button>
                </td>
              </tr>
            </tbody>
          </table>
...
$('.edit-button').on('click', function() {
  var id = $(this).data('id');
  console.log(id);
  // Now that you have the ID, you can use it to retrieve the document from Firestore and make updates as needed.
});
...
const toggleCompleted = id => {
  const index = attendances.value.findIndex(attendance => attendance.id === id)
  attendances.value[index].completed = !attendances.value[index].completed  //UpdateDoc diri dapita 
}
