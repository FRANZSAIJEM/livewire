          ...
          <table class="table table-bordered shadow-sm">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <button class="btn btn-success m-2 " data-bs-toggle="modal" data-bs-target="#exampleModal">&check; Edit</button>
...
const getAttendance = defineProps(['id'])

onMounted(async()=>{
    const attendance = getAttendance.id

    const docRef = doc(db, "tasks", attendance)
...
const updateTask = () => {
    updateDoc(doc(db, 'tasks', attendance), {
        name: name.value,
