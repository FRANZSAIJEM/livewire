<template>
  <div class="body">
    ...
    <div v-for="attendance in attendances" :key="attendance.atte" class="text-center">
      <div class="card-body">
        <div class="row">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <RouterLink :to="{ name: 'edit', params: { id: attendance.id }}" class="text-secondary" id="edit"> <!-- passing the id to the url as an object -->
