              ...
              <tr>
                ...
                <td>
                  ...
                  <RouterLink :to="{ name: 'edit', params: { id: attendance.id }}" class="text-secondary" id="edit"> 
                    ...
                    <button class="btn btn-danger m-2 edit-button" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="fa fa-"></i> Delete</button> 
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button @click="removeAttendance(attendance.id)" class="btn btn-danger m-2" data-bs-dismiss="modal">&cross; Yes</button>
                  </div>
                </div>
              </div>
            </div> 
