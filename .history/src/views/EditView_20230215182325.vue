        ...
        <div class="content">
            <div class="card mt-5">
                ...
                <div class="card-footer">
                    <RouterLink to="/"><Button class="btn btn-secondary"> <i class="fa fa-arrow-left"></i> Back</Button></RouterLink> &nbsp;
                    <button type="button" class="btn btn-primary" @click="updateTask()"> <i class="fa fa-save"></i> Save changes</button>
                </div>
            </div>
        </div>
...
onMounted(async()=>{
    ...
    const docRef = doc(db, "attendance2", attendanceID)
    const docSnap = await getDoc(docRef)
