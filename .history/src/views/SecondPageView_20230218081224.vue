    ...
    <div class="body">
      ...
      <div class="content mt-5">
        ...
        <h1 class="bg-secondary p-3 text-center text-white">Cast Officers</h1>
          ...
          <form action="">
            <div class="input-group mb-5 shadow-lg d-inline-block">
            ...
            <div class="float-start">
              <label for="" class="form-label p-2 d-inline-flex">
              <h3>President:</h3>
              <input v-model="newPresidentInput" type="text" name="" id="" class="form-control ms-2 col-md-5">
            </label>
            </div>
            <div class="ms-lg-auto m-2">
              <button class="btn btn-primary">Add President</button>
            </div>
