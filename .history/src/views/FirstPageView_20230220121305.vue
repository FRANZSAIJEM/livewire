                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                        ...
                        <input v-model="editNameInput.name" type="text" name="" id="" class="form-control p-2" placeholder="Name">
                        </div>


                        <div class="mb-3">
                        <label for="year" class="col-form-label">Year: </label>
                        <select v-model="editYearInput.year" name="" id="year" class="form-select">
                        <option value="BSIT - 1">BSIT - 1</option>
                        <option value="BSIT - 2">BSIT - 2</option>
                        <option value="BSIT - 3">BSIT - 3</option>
                        <option value="BSIT - 4">BSIT - 4</option>
                        ...
                        <select v-model="editAttendanceInput.attendance" name="" id="attendance" class="form-select" typeof="text">
                        <option value="Present">Present</option>
                        <option value="Absent">Absent</option>
                        <option value="Late">Late</option>
                        </select>
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-bs-dismiss="modal"> <i class="fa fa-cancel"></i> Cancel</button>
                    <button @click="updateAttendance()" class="btn btn-primary m-2" data-bs-dismiss="modal"> <i class="fa fa-edit"></i> Save Changes</button>
                  </div>
                </div>
              </div>
            </div> 
