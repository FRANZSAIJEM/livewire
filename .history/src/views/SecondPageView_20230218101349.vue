        ...
        <div class="card-body">
          <div class="row d-inline">
            ...
            <div class="float-start text-start">
              <h2 class="d-flex bg-secondary shadow-lg p-2 rounded-3 text-white">President: <nav class="float-end ms-lg-auto"> <i class="fa fa-president"></i> {{ officer.pres }}</nav>  </h2>
