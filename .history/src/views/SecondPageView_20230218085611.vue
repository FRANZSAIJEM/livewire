<template>
    <div class="body">
      <div class="d-inline-flex m-1">
        ...
        <RouterLink to="/" class="btn btn-success m-1 p-3"> <i class="fa fa-arrow-left"></i> Cast Officers &nbsp; Cast Attendance </RouterLink>
      ...
      <div class="content mt-5">
        ...
        <h1 class="bg-secondary p-3 text-center text-white">Cast Officers</h1>
            ...
            <div class="input-group mb-2 shadow-lg">
              ...
              <input v-model="newNameInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
            ...
            <div class="input-group mb-2 shadow-lg">
              ...
              <input v-model="newNameInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name">
              <button @click="addAttendance()" class="btn btn-success"><i class="fa fa-person"></i> Add</button>
            </div>
