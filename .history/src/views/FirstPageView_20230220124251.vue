<template>
 ...
 -->
                    ...
                    <button @click="editButton(attendance.id)" data-bs-toggle="modal" data-bs-target="#editModal" class="btn btn-success">Edit</button>
...
import {addDoc, collection, onSnapshot,deleteDoc, doc, updateDoc, getDoc} from "firebase/firestore";
