              ...
              <tr>
                ...
                <td>
                  ...
                  <RouterLink :to="{ name: 'edit', params: { id: attendance.id }}" class="text-secondary" id="edit"> 
                    ...
                    <button data-id="{{ attendance.id }}" data-bs-toggle="modal" data-bs-target="#editModal">Edit</button>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-bs-dismiss="modal"> <i class="fa fa-cancel"></i> Cancel</button>
                    <button @click="@click="updateTask()"class="btn btn-danger m-2" data-bs-dismiss="modal"> <i class="fa fa-remove"></i> Yes</button>
                  </div>
                </div>
              </div>
            </div> 
