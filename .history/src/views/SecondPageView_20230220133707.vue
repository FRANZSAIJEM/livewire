<template>
    <div class="body">
      ...
      <div class="content mt-5">
        ...
        <div > 
          <button @click="showForm = !showForm" class="btn btn-primary mt-3 mb-4">
            <i class="fa fa-eye"></i> {{ }}
          </button>
         
          <transition name="slide">
            <div v-show="showForm" class="shadow-sm">
              <button @click="addOfficer()" class="btn btn-success float-end p-3" style="margin-top: -73px;"><i class="fa fa-person"></i> Add</button>
        ...
        <div class="card-body">
          ...
          <div class="row d-inline">
            ...
            <div class="float-start">
              <input type="text" name="" id="" style="margin-right: 1000px; font-size: 25px;" class="mb-3 p-3 w-100 text-center border-0" value="2nd Semester AY 2022-2023">
          ...
          <RouterLink :to="{ name: 'editOfficer', params: { id: officer.id }}" class="text-secondary" id="edit"> 
                        <button class="btn btn-success"><i class="fa fa-edit"></i> Edit</button></RouterLink> 
