              ...
              <tr>
                ...
                <td>
                  ...
                  <RouterLink :to="{ name: 'editAttendance', params: { id: attendance.id }}" class="text-secondary" id="edit"> 
                    ...
                    <button @click="editButton(attendance.id)">Edit</button>
...
function editButton(id) {
  ...
  editAttendance.value = attendanceList.value.find(a => a.id === id);
}
...
function updateAttendance() {
  const index = attendanceList.value.findIndex(a => a.id === editAttendance.value.id);
  attendanceList.value[index] = editAttendance.value;
  closeEditModal();
}
