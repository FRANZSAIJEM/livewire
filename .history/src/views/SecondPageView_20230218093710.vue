<template>
    <div class="body">
      ...
      <div class="content mt-5">
        ...
        <div>
          <button @click="showForm = !showForm" class="btn btn-primary mb-3">{{ showForm ? 'Hide Form' : 'Show Form' }}</button>
          <form v-if="showForm" @submit.prevent="addOfficer()">
            <form action="">
          <div class="input-group mb-2 shadow-lg">
            ...
            <div class="input-group mb-2 shadow-lg">
              ...
              <input v-model="newViceInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
              
            </div>

            <div class="input-group mb-2 shadow-lg">
              <label for="" class=""><h3 class="mt-3 m-2">Secretary:</h3></label>
              <input v-model="newSecInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
              
            </div>

            <div class="input-group mb-2 shadow-lg">
              <label for="" class=""><h3 class="mt-3 m-2">Treasurer:</h3></label>
              <input v-model="newTresInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
              
            </div>

            <div class="input-group mb-2 shadow-lg">
              <label for="" class=""><h3 class="mt-3 m-2">P.I.O:</h3></label>
              <input v-model="newPioInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
              
            </div>

            <div class="input-group mb-2 shadow-lg">
              <label for="" class=""><h3 class="mt-3 m-2">Muse:</h3></label>
              <input v-model="newMuseInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
              
            </div>

            <div class="input-group mb-2 shadow-lg">
              <label for="" class=""><h3 class="mt-3 m-2">Prince:</h3></label>
              <input v-model="newPrinceInput" type="text" name="" id="" class="form-control p-2 m-3" placeholder="Name" required>
            ...
            <button type="submit" class="btn btn-success float-end p-3"><i class="fa fa-person"></i> Add</button>
          </form>
        </div>
