            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-bs-dismiss="modal"> <i class="fa fa-cancel"></i> Cancel</button>
                    <button @click="updateAttend()" class="btn btn-primary m-2" data-bs-dismiss="modal"> <i class="fa fa-edit"></i> Save Changes</button>
                  </div>
                </div>
              </div>
            </div> 
...
const editButton = async (id) => {
  ...
  editYearInput.value = docSnap.data().price
  editAttendanceInput.value = docSnap.data().qty
}
