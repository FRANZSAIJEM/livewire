        ...
        <div class="card-body">
          <div class="row d-inline">
            ...
            <div class="float-start text-start">
              ...
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">Vice President: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">Secretary: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">Treasurer: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">P.I.O: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">Muse: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
              <h2 class="d-flex bg-secondary shadow-lg p-2 mb-2 rounded-3 text-white">Prince: <nav class="float-end ms-lg-auto">{{ officer.pres }}</nav>  </h2>
