<template>
  <div class="body">
    ...
    <div class="container">
      ...
      <input v-model="{{ attendance.name }}" type="text" name="" id="" class="form-control p-2" placeholder="Name">
          ...
          <table class="table table-bordered shadow-sm">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <button @click="editAttendance(attendance.id)" class="btn btn-success m-2 ">&check; Edit</button>
